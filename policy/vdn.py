...
class VDN:
    def __init__(self, args):
        ...
        if self.args.load_model:
            ...
            if os.path.exists(os.path.join(self.model_dir, str(model_index) + '_rnn_net_params.pkl')):
                ...
                path_vdn = os.path.join(self.model_dir, str(model_index) + '_vdn_net_params.pkl')
        ...
        print('Init alg VDN(seed = {})'.format(self.seed))
    ...
    def save_model(self, num):
        ...
        print('Model saved')
        idx = str(num)
        torch.save(self.eval_vdn_net.state_dict(), os.path.join(self.model_dir, idx + '_vdn_net_params.pkl'))
    ...
    def load_model(self, rnn_root, vdn_root):
        ...
        self.eval_vdn_net.load_state_dict(torch.load(vdn_root))
        self.target_rnn.load_state_dict(self.eval_rnn.state_dict())
        self.target_vdn_net.load_state_dict(self.eval_vdn_net.state_dict())
